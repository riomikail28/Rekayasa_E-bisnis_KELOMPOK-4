...
<head>
  ...
  <title>Kontak Kami - <?= htmlspecialchars($settings['site_title'] ?? 'Bucketminiku') ?></title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-12">
        ...
        <p><strong>Alamat:</strong> <?= htmlspecialchars($settings['contact_address'] ?? 'Jl. Bunga Indah No. 123, Jakarta Pusat, Indonesia') ?></p>
        <p><strong>Nomor Telepon:</strong> <?= htmlspecialchars($settings['contact_phone'] ?? '+62 812-XXXX-XXXX') ?></p>
        <p><strong>Email:</strong> <?= htmlspecialchars($settings['contact_email'] ?? 'info@Bucketminiku.com') ?></p>
        <h4>Peta Lokasi</h4>
